...
class App250 extends React.Component {
  constructor(props){
    super(props);
    ...
    let link = "http://localhost:8081/pending?username=" + this.state.username + "&email=" + this.state.email + "&password=" + this.state.password + "&value=250000";
    axios.get(link);
            ...
            <div class="col-md-4 order-md-2 mb-4">
              ...
              <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                  <div>
                    <h6 class="my-0">ExchangeFunding $250,000 Funded Account</h6>
                  </div>
                  <span class="text-muted">$1299</span>
                </li>
